...
container = {
    ...
    'delay_generator': {'show_name': 'Delay Generator', 'class': {'DG535': {'code_path': os.path.join(root_path, 'DG', 'dg535_server.py')},
    ...
    'pressure_regulator': {'show_name': 'Pressure Regulators', 'class': {'GXRegulator': None}},
    'TH': {'show_name': 'TH', 'class': {'TSP01B': None}},
    'Labview_translator': {'show_name': 'Labview Translator', 'class': {'LabviewProgram': None}},
