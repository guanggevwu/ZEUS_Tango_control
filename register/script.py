...
reg_dict = {"power_supply": {'server': 'PowerSupply/testsr', '_class': 'PowerSupply', 'name': 'test/power_supply/1'},
            ...
            "laser_warning_sign": {'server': 'LaserWarningSign/laser_warning_sign_1', '_class': 'LaserWarningSign', 'name': 'facility/laser_warning_sign/laser_warning_sign_1'},
            ...
            "track_lab_1": {'server': 'FileReader/track_lab_1', '_class': 'FileReader', 'name': 'facility/file_reader/track_lab_1', 'property': {'file_type': 'image'}},
            "track_lab_2": {'server': 'FileReader/track_lab_2', '_class': 'FileReader', 'name': 'facility/file_reader/track_lab_2', 'property': {'file_type': 'image'}},
