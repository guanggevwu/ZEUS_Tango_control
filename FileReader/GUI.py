...
parser = TaurusArgparse(
    description='GUI for Basler camera', device_default='facility/file_reader/1', polling_default=1000)
...
if __name__ == "__main__":
    basler_app = FileReaderGUI(args.device, args.polling)
    ...
    image_panel_config = {'TA1_conf1_combine': {"image_number": False, 'command': False}, 'TA2_conf1_combine': {"image_number": False, 'command': False}, 'PW_Comp_In_combine': {'image': 'flux', 'calibration': True},
                          'facility/file_reader/1': {'image_number': False, 'command': False}}
